...
const translations: Translations = {
  ...
  "org.structure": { en: "Structure", fi: "Rakenne" },
  "org.positions": { en: "Positions", fi: "Asemat" },
  "org.addPosition": { en: "Add Position", fi: "Lisää asema" },
  "org.positionName": { en: "Position Name", fi: "Aseman nimi" },
  "org.parentPosition": { en: "Reports to", fi: "Raportoi" },
  "org.noParent": { en: "No parent (Top level)", fi: "Ei yläasemaa (Ylin taso)" },
  "org.memberTitle": { en: "Title", fi: "Titteli" },
  "org.assignPosition": { en: "Assign Position", fi: "Aseta asema" },
  "org.sendEmailInvite": { en: "Send email invitation", fi: "Lähetä sähköpostikutsu" },
  "org.exportStructure": { en: "Export Structure", fi: "Vie rakenne" },
  "org.notes": { en: "Notes", fi: "Muistiinpanot" },
  "org.notesPlaceholder": { en: "Add notes...", fi: "Lisää muistiinpanoja..." },
  "folder.notes": { en: "Notes", fi: "Muistiinpanot" },
  "folder.notesPlaceholder": { en: "Add notes for this folder...", fi: "Lisää muistiinpanoja tälle kansiolle..." },
  "project.notes": { en: "Notes", fi: "Muistiinpanot" },
  "project.notesPlaceholder": { en: "Add internal notes...", fi: "Lisää sisäisiä muistiinpanoja..." },
